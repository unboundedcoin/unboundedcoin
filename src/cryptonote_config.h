...
#define CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX         0x8270
...
#define DEFAULT_FEE                                     ((uint64_t)50000000) // pow5*(10,7)
...
#define P2P_DEFAULT_PORT                                12754
#define RPC_DEFAULT_PORT                                12755
